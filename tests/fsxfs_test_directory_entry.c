...
/* Tests the libfsxfs_directory_entry_initialize function
 * Returns 1 if successful or 0 if not
 */
int fsxfs_test_directory_entry_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsxfs_directory_entry_initialize(
	          &directory_entry,
	          &error );
	...
	result = libfsxfs_directory_entry_free(
	          &directory_entry,
	          &error );
	...
	directory_entry = (libfsxfs_directory_entry_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsxfs_directory_entry_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsxfs_directory_entry_initialize with memset failing
		 */
...
/* Tests the libfsxfs_directory_entry_free function
 * Returns 1 if successful or 0 if not
 */
int fsxfs_test_directory_entry_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FSXFS_TEST_RUN(
	 "libfsxfs_directory_entry_initialize",
	 fsxfs_test_directory_entry_initialize );

	FSXFS_TEST_RUN(
	 "libfsxfs_directory_entry_free",
	 fsxfs_test_directory_entry_free );
