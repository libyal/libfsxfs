...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$Result = RunTestBinary ${TestExecutablesDirectory} "fsxfs_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$Result = RunTestBinaryWithInput ${TestExecutablesDirectory} "fsxfs_test_${TestName}" ${TestInput}
