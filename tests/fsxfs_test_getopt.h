...
#if !defined( _FSXFS_TEST_GETOPT_H )
#define _FSXFS_TEST_GETOPT_H
...
#define fsxfs_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsxfs_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSXFS_TEST_GETOPT_H ) */
