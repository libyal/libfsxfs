...
#include "../libfsxfs/libfsxfs_btree_header.h"

uint8_t fsxfs_test_btree_header_data1[ 512 ] = {
...
/* Tests the libfsxfs_btree_header_initialize function
 * Returns 1 if successful or 0 if not
 */
int fsxfs_test_btree_header_initialize(
     void )
{
	libcerror_error_t *error              = NULL;
	libfsxfs_btree_header_t *btree_header = NULL;
	int result                            = 0;
	...
	/* Test regular cases
	 */
	result = libfsxfs_btree_header_initialize(
	          &btree_header,
	          &error );
	...
	result = libfsxfs_btree_header_free(
	          &btree_header,
	          &error );
	...
	btree_header = (libfsxfs_btree_header_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsxfs_btree_header_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsxfs_btree_header_initialize with memset failing
		 */
...
/* Tests the libfsxfs_btree_header_free function
 * Returns 1 if successful or 0 if not
 */
int fsxfs_test_btree_header_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libfsxfs_btree_header_read_data function
 * Returns 1 if successful or 0 if not
 */
int fsxfs_test_btree_header_read_data(
     void )
{
	libcerror_error_t *error              = NULL;
	libfsxfs_btree_header_t *btree_header = NULL;
...
#endif
{
	...
	FSXFS_TEST_RUN(
	 "libfsxfs_btree_header_initialize",
	 fsxfs_test_btree_header_initialize );

	FSXFS_TEST_RUN(
	 "libfsxfs_btree_header_free",
	 fsxfs_test_btree_header_free );

	FSXFS_TEST_RUN(
	 "libfsxfs_btree_header_read_data",
	 fsxfs_test_btree_header_read_data );
