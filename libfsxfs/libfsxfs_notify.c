...
{
	static char *function = "libfsxfs_notify_set_stream";
...
int libfsxfs_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsxfs_notify_stream_open";
...
int libfsxfs_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfsxfs_notify_stream_close";
