 ...
 */
int libfsxfs_buffer_data_handle_initialize(
     libfsxfs_buffer_data_handle_t **data_handle,
     const uint8_t *data,
     size_t data_size,
     libcerror_error_t **error )
{
	static char *function = "libfsxfs_buffer_data_handle_initialize";
	...
	*data_handle = memory_allocate_structure(
	...
	if( memory_set(
	     *data_handle,
	     0,
	     sizeof( libfsxfs_buffer_data_handle_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_buffer_data_handle_free(
     libfsxfs_buffer_data_handle_t **data_handle,
     libcerror_error_t **error )
{
	static char *function = "libfsxfs_buffer_data_handle_free";
 ...
 */
ssize_t libfsxfs_buffer_data_handle_read_segment_data(
         libfsxfs_buffer_data_handle_t *data_handle,
         intptr_t *file_io_handle LIBFSXFS_ATTRIBUTE_UNUSED,
         int segment_index,
         int segment_file_index LIBFSXFS_ATTRIBUTE_UNUSED,
         uint8_t *segment_data,
         size_t segment_data_size,
         uint32_t segment_flags LIBFSXFS_ATTRIBUTE_UNUSED,
         uint8_t read_flags LIBFSXFS_ATTRIBUTE_UNUSED,
         libcerror_error_t **error )
{
	static char *function = "libfsxfs_buffer_data_handle_read_segment_data";
	size_t read_size      = 0;

	LIBFSXFS_UNREFERENCED_PARAMETER( file_io_handle )
	LIBFSXFS_UNREFERENCED_PARAMETER( segment_file_index )
	LIBFSXFS_UNREFERENCED_PARAMETER( segment_flags )
	LIBFSXFS_UNREFERENCED_PARAMETER( read_flags )
 ...
 */
off64_t libfsxfs_buffer_data_handle_seek_segment_offset(
         libfsxfs_buffer_data_handle_t *data_handle,
         intptr_t *file_io_handle LIBFSXFS_ATTRIBUTE_UNUSED,
         int segment_index,
         int segment_file_index LIBFSXFS_ATTRIBUTE_UNUSED,
         ...
         libcerror_error_t **error )
{
	static char *function = "libfsxfs_buffer_data_handle_seek_segment_offset";
