 ...
 */
int libfsxfs_block_tree_node_initialize(
     libfsxfs_block_tree_node_t **block_tree_node,
     off64_t offset,
     size64_t size,
     size64_t leaf_value_size,
     libcerror_error_t **error )
{
	static char *function  = "libfsxfs_block_tree_node_initialize";
	...
	*block_tree_node = memory_allocate_structure(
	...
	if( memory_set(
	     *block_tree_node,
	     0,
	     sizeof( libfsxfs_block_tree_node_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
	...
	if( libcdata_array_initialize(
	     ...
	     LIBFSXFS_BLOCK_TREE_NUMBER_OF_SUB_NODES,
	     error ) != 1 )
	{
		libcerror_error_set(
		 error,
	...
	while( ( size / sub_node_size ) > LIBFSXFS_BLOCK_TREE_NUMBER_OF_SUB_NODES )
	{
		sub_node_size *= LIBFSXFS_BLOCK_TREE_NUMBER_OF_SUB_NODES;
	}
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_block_tree_node_free(
     libfsxfs_block_tree_node_t **block_tree_node,
     ...
     libcerror_error_t **error )
{
	...
	static char *function                           = "libfsxfs_block_tree_node_free";
	int result                                      = 1;
	...
	if( *block_tree_node != NULL )
	{
		...
		else
		{
			for( sub_node_index = 0;
			     sub_node_index < LIBFSXFS_BLOCK_TREE_NUMBER_OF_SUB_NODES;
			     sub_node_index++ )
			{
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_block_tree_node_get_sub_node_at_offset(
     libfsxfs_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsxfs_block_tree_node_t **sub_block_tree_node,
     libcerror_error_t **error )
{
	static char *function  = "libfsxfs_block_tree_node_get_sub_node_at_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_block_tree_node_set_sub_node_at_offset(
     libfsxfs_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsxfs_block_tree_node_t *sub_block_tree_node,
     libcerror_error_t **error )
{
	static char *function  = "libfsxfs_block_tree_node_set_sub_node_at_offset";
	off64_t sub_node_index = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_block_tree_node_get_leaf_value_at_offset(
     libfsxfs_block_tree_node_t *block_tree_node,
     off64_t offset,
     ...
     libcerror_error_t **error )
{
	static char *function     = "libfsxfs_block_tree_node_get_leaf_value_at_offset";
 ...
 * Returns 1 if successful or -1 on error
 */
int libfsxfs_block_tree_node_set_leaf_value_at_offset(
     libfsxfs_block_tree_node_t *block_tree_node,
     off64_t offset,
     libfsxfs_block_descriptor_t *block_descriptor,
     libcerror_error_t **error )
{
	static char *function    = "libfsxfs_block_tree_node_set_leaf_value_at_offset";
	off64_t leaf_value_index = 0;
