...
#if !defined( _LIBFSXFS_LIBCTHREADS_H )
#define _LIBFSXFS_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBFSXFS )
#define HAVE_LIBFSXFS_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBFSXFS_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBFSXFS_LIBCTHREADS_H ) */
