...
#include "libfsxfs_libclocale.h"
#include "libfsxfs_libcnotify.h"
#include "libfsxfs_superblock.h"
#include "libfsxfs_support.h"
...
const char *libfsxfs_get_version(
             void )
{
	return( (const char *) LIBFSXFS_VERSION_STRING );
}
...
int libfsxfs_get_access_flags_read(
     void )
{
	return( (int) LIBFSXFS_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfsxfs_get_codepage";
...
int libfsxfs_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsxfs_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libfsxfs_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libfsxfs_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libfsxfs_check_volume_signature_file_io_handle";
	     ...
	     error ) == -1 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to seek signature offset: 0 (0x00000000).",
		 function );
