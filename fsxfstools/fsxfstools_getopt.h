...
#if !defined( _FSXFSTOOLS_GETOPT_H )
#define _FSXFSTOOLS_GETOPT_H
...
typedef struct fsxfstools_option fsxfstools_option_t;

struct fsxfstools_option
{
...
#define fsxfstools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsxfstools_getopt(
                  int argument_count,
...
void fsxfstools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsxfstools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsxfstools_option_t *options,
      int number_of_options );

int fsxfstools_getopt_get_options_string(
     const fsxfstools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _FSXFSTOOLS_GETOPT_H ) */
