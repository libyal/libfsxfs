...
int mount_file_system_set_volume(
     mount_file_system_t *file_system,
     libfsxfs_volume_t *fsxfs_volume,
     libcerror_error_t **error )
{
	...
	file_system->fsxfs_volume = fsxfs_volume;
     ...
     libcerror_error_t **error )
{
	...
	*fsxfs_volume = file_system->fsxfs_volume;
