...
/* The pyfsxfs module methods
 */
PyMethodDef pyfsxfs_module_methods[] = {
	{ "get_version",
	  (PyCFunction) pyfsxfs_get_version,
	  METH_NOARGS,
	  "get_version() -> String\n"
	  "\n"
	...
	{ "check_volume_signature",
	  (PyCFunction) pyfsxfs_check_volume_signature,
	...
	{ "open_file_object",
	  (PyCFunction) pyfsxfs_open_new_volume_with_file_object,
	  METH_VARARGS | METH_KEYWORDS,
...
/* Retrieves the pyfsxfs/libfsxfs version
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfsxfs_get_version(
           PyObject *self PYFSXFS_ATTRIBUTE_UNUSED,
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	const char *version_string   = NULL;
	size_t version_string_length = 0;

	PYFSXFS_UNREFERENCED_PARAMETER( self )
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error         = NULL;
	static char *function            = "pyfsxfs_check_volume_signature_file_object";
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfsxfs_open_new_volume(
           PyObject *self PYFSXFS_ATTRIBUTE_UNUSED,
           PyObject *arguments,
           PyObject *keywords )
{
	pyfsxfs_volume_t *pyfsxfs_volume = NULL;
	static char *function            = "pyfsxfs_open_new_volume";

	PYFSXFS_UNREFERENCED_PARAMETER( self )

	/* PyObject_New does not invoke tp_init
	 */
	pyfsxfs_volume = PyObject_New(
	                  struct pyfsxfs_volume,
	                  &pyfsxfs_volume_type_object );
	...
	if( pyfsxfs_volume_init(
	     pyfsxfs_volume ) != 0 )
	{
		goto on_error;
	}
	if( pyfsxfs_volume_open(
	     pyfsxfs_volume,
	     arguments,
	     keywords ) == NULL )
	{
	...
	return( (PyObject *) pyfsxfs_volume );
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyfsxfs_open_new_volume_with_file_object(
           PyObject *self PYFSXFS_ATTRIBUTE_UNUSED,
           PyObject *arguments,
           PyObject *keywords )
{
	pyfsxfs_volume_t *pyfsxfs_volume = NULL;
	static char *function            = "pyfsxfs_open_new_volume_with_file_object";
	...
	if( pyfsxfs_volume_open_file_object(
	     pyfsxfs_volume,
	     arguments,
	     keywords ) == NULL )
	{
...
/* The pyfsxfs module definition
 */
PyModuleDef pyfsxfs_module_definition = {
	PyModuleDef_HEAD_INIT,

	/* m_name */
	"pyfsxfs",
	/* m_doc */
	"Python libfsxfs module (pyfsxfs).",
	/* m_size */
	-1,
	/* m_methods */
	pyfsxfs_module_methods,
	/* m_reload */
	NULL,
	/* m_traverse */
	NULL,
...
/* Initializes the pyfsxfs module
 */
#if PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC PyInit_pyfsxfs(
                void )
#else
PyMODINIT_FUNC initpyfsxfs(
                void )
#endif
{
	 ...
	 */
	pyfsxfs_volume_type_object.tp_new = PyType_GenericNew;

	if( PyType_Ready(
	     &pyfsxfs_volume_type_object ) < 0 )
	{
		goto on_error;
	}
	Py_IncRef(
	 (PyObject *) &pyfsxfs_volume_type_object );
