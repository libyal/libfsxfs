...
PyMethodDef pyfsxfs_extended_attribute_object_methods[] = {

	{ "get_name",
	  (PyCFunction) pyfsxfs_extended_attribute_get_name,
	  METH_NOARGS,
	...
	{ "get_offset",
	  (PyCFunction) pyfsxfs_extended_attribute_get_offset,
	  METH_NOARGS,
	  "get_offset() -> Integer\n"
	  "\n"
	...
	{ "get_size",
	  (PyCFunction) pyfsxfs_extended_attribute_get_size,
	  METH_NOARGS,
	  "get_size() -> Integer\n"
	  "\n"
...
PyGetSetDef pyfsxfs_extended_attribute_object_get_set_definitions[] = {

	{ "name",
	  (getter) pyfsxfs_extended_attribute_get_name,
	  (setter) 0,
	  "The name.",
	  NULL },

	{ "size",
	  (getter) pyfsxfs_extended_attribute_get_size,
	  (setter) 0,
...
PyTypeObject pyfsxfs_extended_attribute_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsxfs.extended_attribute",
	/* tp_basicsize */
	sizeof( pyfsxfs_extended_attribute_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsxfs_extended_attribute_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyfsxfs extended attribute object (wraps libfsxfs_extended_attribute_t)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_methods */
	pyfsxfs_extended_attribute_object_methods,
	/* tp_members */
	0,
	/* tp_getset */
	pyfsxfs_extended_attribute_object_get_set_definitions,
	/* tp_base */
	0,
	/* tp_dict */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsxfs_extended_attribute_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
{
	pyfsxfs_extended_attribute_t *pyfsxfs_extended_attribute = NULL;
	static char *function                                      = "pyfsxfs_extended_attribute_new";
	 ...
	 */
	pyfsxfs_extended_attribute = PyObject_New(
	                               struct pyfsxfs_extended_attribute,
	                               &pyfsxfs_extended_attribute_type_object );
	...
	pyfsxfs_extended_attribute->extended_attribute = extended_attribute;
	pyfsxfs_extended_attribute->parent_object      = parent_object;

	if( pyfsxfs_extended_attribute->parent_object != NULL )
	{
		Py_IncRef(
		 pyfsxfs_extended_attribute->parent_object );
	}
	return( (PyObject *) pyfsxfs_extended_attribute );

on_error:
	if( pyfsxfs_extended_attribute != NULL )
	{
		Py_DecRef(
		 (PyObject *) pyfsxfs_extended_attribute );
	}
	return( NULL );
}
...
{
	static char *function = "pyfsxfs_extended_attribute_init";
	...
	/* Make sure libfsxfs extended attribute is set to NULL
	 */
	pyfsxfs_extended_attribute->extended_attribute = NULL;
      ...
      pyfsxfs_extended_attribute_t *pyfsxfs_extended_attribute )
{
	...
	static char *function       = "pyfsxfs_extended_attribute_free";
	int result                  = 0;
	...
	if( pyfsxfs_extended_attribute->extended_attribute != NULL )
	{
		Py_BEGIN_ALLOW_THREADS

		result = libfsxfs_extended_attribute_free(
		...
		if( result != 1 )
		{
			pyfsxfs_error_raise(
			 error,
			 PyExc_MemoryError,
			 "%s: unable to free libfsxfs extended attribute.",
			 function );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_extended_attribute_get_name";
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsxfs_extended_attribute_read_buffer";
	      ...
	      || ( integer_object == Py_None ) )
	{
		...
		result = libfsxfs_extended_attribute_get_size(
		          pyfsxfs_extended_attribute->extended_attribute,
		          (size64_t *) &read_size,
		          &error );
	...
	read_count = libfsxfs_extended_attribute_read_buffer(
	              pyfsxfs_extended_attribute->extended_attribute,
	              (uint8_t *) buffer,
	              (size_t) read_size,
	              &error );
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsxfs_extended_attribute_read_buffer_at_offset";
	...
	read_count = libfsxfs_extended_attribute_read_buffer_at_offset(
	              pyfsxfs_extended_attribute->extended_attribute,
	              (uint8_t *) buffer,
	              (size_t) read_size,
	              (off64_t) read_offset,
...
{
	libcerror_error_t *error    = NULL;
	static char *function       = "pyfsxfs_extended_attribute_seek_offset";
	...
	offset = libfsxfs_extended_attribute_seek_offset(
	          pyfsxfs_extended_attribute->extended_attribute,
	          offset,
	          whence,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_extended_attribute_get_offset";
	off64_t offset           = 0;
	int result               = 0;
	...
	result = libfsxfs_extended_attribute_get_offset(
	          pyfsxfs_extended_attribute->extended_attribute,
	          &offset,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_extended_attribute_get_size";
	size64_t size            = 0;
	int result               = 0;
