...
PySequenceMethods pyfsxfs_file_entries_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfsxfs_file_entries_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfsxfs_file_entries_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfsxfs_file_entries_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsxfs.file_entries",
	/* tp_basicsize */
	sizeof( pyfsxfs_file_entries_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsxfs_file_entries_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfsxfs_file_entries_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfsxfs sequence and iterator object of file entries",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfsxfs_file_entries_iter,
	/* tp_iternext */
	(iternextfunc) pyfsxfs_file_entries_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsxfs_file_entries_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfsxfs_file_entries_new(
           ...
           int number_of_items )
{
	pyfsxfs_file_entries_t *sequence_object = NULL;
	static char *function                   = "pyfsxfs_file_entries_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyfsxfs_file_entries_type_object );
...
{
	static char *function = "pyfsxfs_file_entries_init";
      ...
      pyfsxfs_file_entries_t *sequence_object )
{
	...
	static char *function       = "pyfsxfs_file_entries_free";
...
Py_ssize_t pyfsxfs_file_entries_len(
            pyfsxfs_file_entries_t *sequence_object )
{
	static char *function = "pyfsxfs_file_entries_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function       = "pyfsxfs_file_entries_getitem";
...
PyObject *pyfsxfs_file_entries_iter(
           pyfsxfs_file_entries_t *sequence_object )
{
	static char *function = "pyfsxfs_file_entries_iter";
...
{
	PyObject *file_entry_object = NULL;
	static char *function       = "pyfsxfs_file_entries_iternext";
