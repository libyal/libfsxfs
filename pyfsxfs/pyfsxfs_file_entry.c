...
PyMethodDef pyfsxfs_file_entry_object_methods[] = {

	{ "get_inode_number",
	  (PyCFunction) pyfsxfs_file_entry_get_inode_number,
	  METH_NOARGS,
	...
	{ "get_creation_time",
	  (PyCFunction) pyfsxfs_file_entry_get_creation_time,
	  METH_NOARGS,
	...
	{ "get_creation_time_as_integer",
	  (PyCFunction) pyfsxfs_file_entry_get_creation_time_as_integer,
	  METH_NOARGS,
	  "get_creation_time_as_integer() -> Integer or None\n"
	  "\n"
	  "Retrieves the creation date and time as a 32-bit integer containing a POSIX timestamp value." },

	{ "get_modification_time",
	  (PyCFunction) pyfsxfs_file_entry_get_modification_time,
	  METH_NOARGS,
	...
	{ "get_modification_time_as_integer",
	  (PyCFunction) pyfsxfs_file_entry_get_modification_time_as_integer,
	  METH_NOARGS,
	...
	{ "get_inode_change_time",
	  (PyCFunction) pyfsxfs_file_entry_get_inode_change_time,
	  METH_NOARGS,
	...
	{ "get_inode_change_time_as_integer",
	  (PyCFunction) pyfsxfs_file_entry_get_inode_change_time_as_integer,
	  METH_NOARGS,
	  "get_inode_change_time_as_integer() -> Integer\n"
	  "\n"
	  "Retrieves the entry modification date and time as a 32-bit integer containing a POSIX timestamp value." },

	{ "get_access_time",
	  (PyCFunction) pyfsxfs_file_entry_get_access_time,
	  METH_NOARGS,
	...
	{ "get_access_time_as_integer",
	  (PyCFunction) pyfsxfs_file_entry_get_access_time_as_integer,
	  METH_NOARGS,
	...
	{ "get_file_mode",
	  (PyCFunction) pyfsxfs_file_entry_get_file_mode,
	  METH_NOARGS,
	...
	{ "get_group_identifier",
	  (PyCFunction) pyfsxfs_file_entry_get_group_identifier,
	  METH_NOARGS,
	...
	{ "get_device_number",
	  (PyCFunction) pyfsxfs_file_entry_get_device_number,
	  METH_NOARGS,
	...
	{ "get_name",
	  (PyCFunction) pyfsxfs_file_entry_get_name,
	  METH_NOARGS,
	...
	{ "get_symbolic_link_target",
	  (PyCFunction) pyfsxfs_file_entry_get_symbolic_link_target,
	  METH_NOARGS,
	...
	{ "has_extended_attribute_by_name",
	  (PyCFunction) pyfsxfs_file_entry_has_extended_attribute_by_name,
	  METH_VARARGS | METH_KEYWORDS,
	...
	{ "get_extended_attribute_by_name",
	  (PyCFunction) pyfsxfs_file_entry_get_extended_attribute_by_name,
	  METH_VARARGS | METH_KEYWORDS,
	...
	{ "get_sub_file_entry",
	  (PyCFunction) pyfsxfs_file_entry_get_sub_file_entry,
	  METH_VARARGS | METH_KEYWORDS,
	...
	{ "get_sub_file_entry_by_name",
	  (PyCFunction) pyfsxfs_file_entry_get_sub_file_entry_by_name,
	  METH_VARARGS | METH_KEYWORDS,
	...
	{ "get_offset",
	  (PyCFunction) pyfsxfs_file_entry_get_offset,
	  METH_NOARGS,
	  "get_offset() -> Integer\n"
	  "\n"
	...
	{ "get_size",
	  (PyCFunction) pyfsxfs_file_entry_get_size,
	  METH_NOARGS,
	  "get_size() -> Integer\n"
	  "\n"
	...
	{ "get_number_of_extents",
	  (PyCFunction) pyfsxfs_file_entry_get_number_of_extents,
	  METH_NOARGS,
	...
	{ "get_extent",
	  (PyCFunction) pyfsxfs_file_entry_get_extent,
	  METH_VARARGS | METH_KEYWORDS,
...
PyGetSetDef pyfsxfs_file_entry_object_get_set_definitions[] = {

	{ "inode_number",
	  (getter) pyfsxfs_file_entry_get_inode_number,
	  (setter) 0,
	  "The inode number.",
	  NULL },

	{ "creation_time",
	  (getter) pyfsxfs_file_entry_get_creation_time,
	  (setter) 0,
	  "The creation date and time.",
	  NULL },

	{ "modification_time",
	  (getter) pyfsxfs_file_entry_get_modification_time,
	  (setter) 0,
	  "The modification date and time.",
	  NULL },

	{ "inode_change_time",
	  (getter) pyfsxfs_file_entry_get_inode_change_time,
	  (setter) 0,
	  "The entry modification date and time.",
	  NULL },

	{ "access_time",
	  (getter) pyfsxfs_file_entry_get_access_time,
	  (setter) 0,
	  "The access date and time.",
	  NULL },

	{ "file_mode",
	  (getter) pyfsxfs_file_entry_get_file_mode,
	  (setter) 0,
	  "The file mode.",
	  NULL },
	...
	{ "group_identifier",
	  (getter) pyfsxfs_file_entry_get_group_identifier,
	  (setter) 0,
	  "The group identifier.",
	  NULL },

	{ "device_number",
	  (getter) pyfsxfs_file_entry_get_device_number,
	  (setter) 0,
	  "The device number.",
	  NULL },

	{ "name",
	  (getter) pyfsxfs_file_entry_get_name,
	  (setter) 0,
	  "The name.",
	  NULL },
	...
	{ "number_of_sub_file_entries",
	  (getter) pyfsxfs_file_entry_get_number_of_sub_file_entries,
	  (setter) 0,
	  "The number of sub file entries.",
	  NULL },

	{ "sub_file_entries",
	  (getter) pyfsxfs_file_entry_get_sub_file_entries,
	  (setter) 0,
	  "The sub file entry for the specific indexes.",
	  NULL },

	{ "size",
	  (getter) pyfsxfs_file_entry_get_size,
	  (setter) 0,
	  "The size of the data.",
	  NULL },

	{ "number_of_extents",
	  (getter) pyfsxfs_file_entry_get_number_of_extents,
	  (setter) 0,
...
PyTypeObject pyfsxfs_file_entry_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsxfs.file_entry",
	/* tp_basicsize */
	sizeof( pyfsxfs_file_entry_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsxfs_file_entry_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyfsxfs file entry object (wraps libfsxfs_file_entry_t)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_methods */
	pyfsxfs_file_entry_object_methods,
	/* tp_members */
	0,
	/* tp_getset */
	pyfsxfs_file_entry_object_get_set_definitions,
	/* tp_base */
	0,
	/* tp_dict */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsxfs_file_entry_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
{
	pyfsxfs_file_entry_t *pyfsxfs_file_entry = NULL;
	static char *function                    = "pyfsxfs_file_entry_new";
	 ...
	 */
	pyfsxfs_file_entry = PyObject_New(
	                      struct pyfsxfs_file_entry,
	                      &pyfsxfs_file_entry_type_object );
	...
	pyfsxfs_file_entry->file_entry    = file_entry;
	pyfsxfs_file_entry->parent_object = parent_object;

	if( pyfsxfs_file_entry->parent_object != NULL )
	{
		Py_IncRef(
		 pyfsxfs_file_entry->parent_object );
	}
	return( (PyObject *) pyfsxfs_file_entry );
...
{
	static char *function = "pyfsxfs_file_entry_init";
	...
	/* Make sure libfsxfs file entry is set to NULL
	 */
	pyfsxfs_file_entry->file_entry = NULL;
      ...
      pyfsxfs_file_entry_t *pyfsxfs_file_entry )
{
	...
	static char *function       = "pyfsxfs_file_entry_free";
	int result                  = 0;
	...
	if( pyfsxfs_file_entry->file_entry != NULL )
	{
		...
		if( result != 1 )
		{
			pyfsxfs_error_raise(
			 error,
			 PyExc_MemoryError,
			 "%s: unable to free libfsxfs file entry.",
			 function );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_inode_number";
	...
	result = libfsxfs_file_entry_get_inode_number(
	          pyfsxfs_file_entry->file_entry,
	          &value_64bit,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error  = NULL;
	static char *function     = "pyfsxfs_file_entry_get_creation_time";
	...
	datetime_object = pyfsxfs_datetime_new_from_posix_time_in_micro_seconds(
	                   posix_time / 1000 );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_creation_time_as_integer";
	int64_t posix_time       = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *datetime_object = NULL;
	libcerror_error_t *error  = NULL;
	static char *function     = "pyfsxfs_file_entry_get_modification_time";
	int64_t posix_time        = 0;
	int result                = 0;
	...
	result = libfsxfs_file_entry_get_modification_time(
	          pyfsxfs_file_entry->file_entry,
	          &posix_time,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_modification_time_as_integer";
	int64_t posix_time       = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *datetime_object = NULL;
	libcerror_error_t *error  = NULL;
	static char *function     = "pyfsxfs_file_entry_get_inode_change_time";
	int64_t posix_time        = 0;
	int result                = 0;
	...
	result = libfsxfs_file_entry_get_inode_change_time(
	          pyfsxfs_file_entry->file_entry,
	          &posix_time,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_inode_change_time_as_integer";
	int64_t posix_time       = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *datetime_object = NULL;
	libcerror_error_t *error  = NULL;
	static char *function     = "pyfsxfs_file_entry_get_access_time";
	int64_t posix_time        = 0;
	int result                = 0;
	...
	result = libfsxfs_file_entry_get_access_time(
	          pyfsxfs_file_entry->file_entry,
	          &posix_time,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_access_time_as_integer";
	int64_t posix_time       = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_file_mode";
	...
	result = libfsxfs_file_entry_get_file_mode(
	          pyfsxfs_file_entry->file_entry,
	          &file_mode,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error     = NULL;
	static char *function        = "pyfsxfs_file_entry_get_device_number";
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error = NULL;
	uint8_t *name            = NULL;
	static char *function    = "pyfsxfs_file_entry_get_name";
	size_t name_size         = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	...
	PyObject *string_object  = NULL;
	uint8_t *target          = NULL;
	static char *function    = "pyfsxfs_file_entry_get_symbolic_link_target";
           ...
           PyObject *keywords )
{
	...
	static char *function                 = "pyfsxfs_file_entry_has_extended_attribute_by_name";
	...
	result = libfsxfs_file_entry_has_extended_attribute_by_utf8_name(
	           pyfsxfs_file_entry->file_entry,
           ...
           PyObject *keywords )
{
	...
	char *extended_attribute_name                      = NULL;
	static char *keyword_list[]                        = { "extended_attribute_name", NULL };
	static char *function                              = "pyfsxfs_file_entry_get_extended_attribute_by_name";
	size_t extended_attribute_name_length              = 0;
	int result                                         = 0;
	...
	result = libfsxfs_file_entry_get_extended_attribute_by_utf8_name(
	           pyfsxfs_file_entry->file_entry,
	           (uint8_t *) extended_attribute_name,
	           extended_attribute_name_length,
	           &extended_attribute,
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object       = NULL;
	libcerror_error_t *error       = NULL;
	static char *function          = "pyfsxfs_file_entry_get_number_of_sub_file_entries";
	...
	result = libfsxfs_file_entry_get_number_of_sub_file_entries(
	          pyfsxfs_file_entry->file_entry,
	          &number_of_sub_file_entries,
	          &error );
           ...
           int sub_file_entry_index )
{
	...
	static char *function                 = "pyfsxfs_file_entry_get_sub_file_entry_by_index";
	int result                            = 0;
	...
	file_entry_object = pyfsxfs_file_entry_new(
	                     sub_file_entry,
	                     ( (pyfsxfs_file_entry_t *) pyfsxfs_file_entry )->parent_object );
           ...
           PyObject *keywords )
{
	...
	file_entry_object = pyfsxfs_file_entry_get_sub_file_entry_by_index(
	                     (PyObject *) pyfsxfs_file_entry,
	                     sub_file_entry_index );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *sequence_object      = NULL;
	libcerror_error_t *error       = NULL;
	static char *function          = "pyfsxfs_file_entry_get_sub_file_entries";
	int number_of_sub_file_entries = 0;
	int result                     = 0;
	...
	sequence_object = pyfsxfs_file_entries_new(
	                   (PyObject *) pyfsxfs_file_entry,
	                   &pyfsxfs_file_entry_get_sub_file_entry_by_index,
	                   number_of_sub_file_entries );
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error              = NULL;
	libfsxfs_file_entry_t *sub_file_entry = NULL;
	static char *function                 = "pyfsxfs_file_entry_get_sub_file_entry_by_name";
	...
	result = libfsxfs_file_entry_get_sub_file_entry_by_utf8_name(
	          pyfsxfs_file_entry->file_entry,
	          (uint8_t *) utf8_name,
	          utf8_name_length,
	          &sub_file_entry,
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsxfs_file_entry_read_buffer";
	...
	if( result != 0 )
	{
		if( pyfsxfs_integer_signed_copy_to_64bit(
		     integer_object,
		     &read_size,
		     &error ) != 1 )
		{
	      ...
	      || ( integer_object == Py_None ) )
	{
		...
		result = libfsxfs_file_entry_get_size(
		          pyfsxfs_file_entry->file_entry,
		          (size64_t *) &read_size,
		          &error );
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsxfs_file_entry_read_buffer_at_offset";
	...
	read_count = libfsxfs_file_entry_read_buffer_at_offset(
	              pyfsxfs_file_entry->file_entry,
	              (uint8_t *) buffer,
	              (size_t) read_size,
	              (off64_t) read_offset,
...
{
	libcerror_error_t *error    = NULL;
	static char *function       = "pyfsxfs_file_entry_seek_offset";
	...
	offset = libfsxfs_file_entry_seek_offset(
	          pyfsxfs_file_entry->file_entry,
	          offset,
	          whence,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_offset";
	off64_t offset           = 0;
	int result               = 0;
	...
	result = libfsxfs_file_entry_get_offset(
	          pyfsxfs_file_entry->file_entry,
	          &offset,
	          &error );
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_size";
	size64_t size            = 0;
	int result               = 0;
           ...
           PyObject *arguments PYFSXFS_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsxfs_file_entry_get_number_of_extents";
	...
	result = libfsxfs_file_entry_get_number_of_extents(
	          pyfsxfs_file_entry->file_entry,
	          &number_of_extents,
	          &error );
           ...
           int extent_index )
{
	...
	PyObject *integer_object = NULL;
	PyObject *tuple_object   = NULL;
	static char *function    = "pyfsxfs_file_entry_get_extent_by_index";
	...
	result = libfsxfs_file_entry_get_extent_by_index(
	          pyfsxfs_file_entry->file_entry,
	          extent_index,
	          &extent_offset,
	          &extent_size,
           ...
           PyObject *keywords )
{
	...
	sequence_object = pyfsxfs_file_entry_get_extent_by_index(
	                   pyfsxfs_file_entry,
	                   extent_index );
