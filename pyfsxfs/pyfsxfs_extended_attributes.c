...
PySequenceMethods pyfsxfs_extended_attributes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfsxfs_extended_attributes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfsxfs_extended_attributes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfsxfs_extended_attributes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsxfs.extended_attributes",
	/* tp_basicsize */
	sizeof( pyfsxfs_extended_attributes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsxfs_extended_attributes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfsxfs_extended_attributes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfsxfs sequence and iterator object of extended attributes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfsxfs_extended_attributes_iter,
	/* tp_iternext */
	(iternextfunc) pyfsxfs_extended_attributes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsxfs_extended_attributes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfsxfs_extended_attributes_new(
           ...
           int number_of_items )
{
	pyfsxfs_extended_attributes_t *sequence_object = NULL;
	static char *function                           = "pyfsxfs_extended_attributes_new";
	...
	sequence_object = PyObject_New(
	                   ...
	                   &pyfsxfs_extended_attributes_type_object );
...
{
	static char *function = "pyfsxfs_extended_attributes_init";
      ...
      pyfsxfs_extended_attributes_t *sequence_object )
{
	...
	static char *function       = "pyfsxfs_extended_attributes_free";
...
Py_ssize_t pyfsxfs_extended_attributes_len(
            pyfsxfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsxfs_extended_attributes_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function               = "pyfsxfs_extended_attributes_getitem";
...
PyObject *pyfsxfs_extended_attributes_iter(
           pyfsxfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsxfs_extended_attributes_iter";
...
{
	PyObject *extended_attribute_object = NULL;
	static char *function               = "pyfsxfs_extended_attributes_iternext";
